...
namespace AdmSindWebAppV02.Extensions.Identity
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "AdmSindWebAppV02.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "AdmSindWebAppV02.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
